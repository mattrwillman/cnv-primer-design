...
#SBATCH --job-name="Rht8_primer3"            #name of the job submitted
#SBATCH -p atlas                      #name of the queue you are submitting job to
#SBATCH -A gbru_wheat2
#SBATCH -N 1                            #number of nodes in this job
#SBATCH -n 1                           #number of cores/tasks in this job
...
source activate /project/gbru_wheat2/conda/primer3_env

primer3_core --output=primer3_out.txt Rht8_primer3_tags.txt
